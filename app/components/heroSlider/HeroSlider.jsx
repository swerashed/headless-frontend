  ...
  return (
    <section className="relative flex h-[90vh] items-end justify-center">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 flex flex-col bg-hero-gradient px-[15px] pb-[30px] pt-[70px] lg:px-[75px] lg:pt-[75px]">
        <h1
          data-aos="fade-down"
          className="mb-10 max-w-[720px] font-onest text-4xl font-medium leading-tight text-white md:mb-[60px] md:text-5xl"
        >
          Expanding Health Horizons with Trusted Partners
        </h1>
