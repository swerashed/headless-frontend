...
function CounterCard({ counter }) {
  return (
    <div
      data-aos="fade-up"
      className="group relative flex flex-col justify-between gap-5 rounded-xl border border-dark/10 p-[15px] shadow-sm shadow-dark/10 transition-all duration-300 hover:shadow-md md:gap-[66px] md:p-[30px]"
    >
