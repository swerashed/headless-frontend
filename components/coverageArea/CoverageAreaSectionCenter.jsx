...
export function CoverageAreaSectionCenter({data, outlets}) {
  const { title, description, cta_description, cta_url, page, outlet_section_title } = data
  return (
    <section className="overflow-hidden py-[50px] md:py-[100px]">
      <div className="container">
        ...
        <CoverageAreaTable outlet_section_title={outlet_section_title}  cta_description={cta_description}  cta_url={cta_url} outlets={outlets}/>
