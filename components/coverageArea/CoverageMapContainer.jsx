...
function CoverageMapContainer({imageData, districts, page}) {
  ...
  return (
    <div className="md:col-span-1 md:row-span-2" data-aos="fade-left">
      ...
      {page === "service" &&  <div><Image src={imageData} alt="Map Image" height={700} width={500}/></div>}
      {page === "diagnostics" && <div><Image src={imageData} alt="Map Image" height={700} width={500}/></div>}
