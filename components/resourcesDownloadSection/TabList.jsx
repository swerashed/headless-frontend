  ...
  return (
    <Tabs defaultValue={defaultYear} className="mt-10 w-full">
      <TabsList
        data-aos="fade-up"
        ref={tabsListRef}
        className="m-0 mb-10 flex h-auto justify-start gap-0 overflow-x-auto scroll-smooth rounded-none border-b border-[#1623401A] bg-surface p-0"
      ...
      >
        {result
          ...
          .map((result, index) => (
            <TabsTrigger
              key={index}
              className="flex h-auto rounded-none border-0 border-b-2 border-transparent bg-transparent px-6 py-6 text-center font-onest text-xl font-medium leading-[30px] text-dark/80 transition-all duration-300 data-[state=active]:border-blue data-[state=active]:bg-inherit data-[state=active]:text-blue data-[state=active]:shadow-none"
