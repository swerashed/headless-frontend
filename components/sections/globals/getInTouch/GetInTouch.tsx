  ...
  return (
    <section className="bg-dark relative">
      <div className="container-fractal">
        <div className="z-10 flex w-full flex-col gap-7.5 py-15 sm:max-w-lg sm:gap-10 md:max-w-xl md:gap-14 md:py-33.75 lg:max-w-194.5 lg:gap-20">
          ...
          <div className="z-10 flex w-full flex-col gap-6">
            ...
            <BodyText variant="body3" className="max-w-md lg:max-w-125.75">
              Have a difficult communications problem? Reach out, we’re always
              happy to chat.
            </BodyText>
          </div>
          {/* Form Fields */}
        ...
        <Image
          src="/home/get-in-touch/fractal-tree-mobile.svg"
          alt="Hero tree"
          width={360}
          height={606}
        ...
        />
        <Image
          src="/home/get-in-touch/fractal-tree-desktop.svg"
          alt="Hero tree"
          width={360}
          height={606}
          className="absolute top-0 right-0 bottom-0 left-0 z-0 hidden h-full w-full object-cover md:block"
        />
      </div>
    </section>
  );
