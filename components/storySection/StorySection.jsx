function StorySection() {
  return (
    <section className="mb-10 mt-[60px] md:mb-[80px] md:mt-[100px]">
      <div className="container">
        <h3 className="mb-5 border-b border-b-dark/10 pb-5 font-inter text-sm font-medium uppercase leading-none text-dark md:mb-10 md:pb-6 md:text-base">
