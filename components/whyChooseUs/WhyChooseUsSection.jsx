...
function WhyChooseUsSection({ data }) {
  const { section_classnames, image, title, body_text, choose_us_items } = data;
  return (
    <section
      className={cn(
    ...
    >
      <div className="container">
        <div className="flex flex-col gap-10 md:gap-10 lg:items-center lg:gap-10 xl:flex-row xl:items-center xl:gap-10">
          <Image
            src={image}
            alt="Why choose us banner"
            width={625}
            height={625}
            className="h-auto min-h-[330px] w-full rounded-[20px] object-cover shadow-md shadow-dark/10 md:min-h-[600px] xl:min-h-[625px] xl:w-1/2"
            data-aos="fade-right"
          />
